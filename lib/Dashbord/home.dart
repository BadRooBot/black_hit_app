...
// Map<String, dynamic> UserInfoList = [] as Map<String, dynamic>;
// bool VIP = false;
// bool VIP2 = false;
...
//       initialPage: 0, viewportFraction: 1.0, keepPage: false);
...
//      });*/
//     }
//     if ((UserInfoList[0]['name'] == "OneLand User") ||
//         UserInfoList[0]['name'] == null) {
//       Navigator.pushNamed(
//         context,
//         '/getUserInfo',
//         arguments: {'id': id},
...
//         height: 80,
//         child: UnityBannerAd(placementId: AdManager.bannerAdPlacementId),
//       ),
//     );
//   }
...
//                               var dataUpdate = await realtimeDb()
//                                   .GetOneUserData(
...
//                                       element['VIP']) {
//                                     await myStore
//                                         .update({'VIP': element['VIP']});
//                                   }
//                                   if (snapshot.data!.docs[num]['Online'] !=
//                                       element['Online']) {
//                                     await myStore
//                                         .update({'Online': element['Online']});
//                                   }
//                                 }
//                               });
//                             } else {
//                               var nAndI = await _firestore
//                                   .collection('Group')
//                                   .where('GroupId',
//                                       isEqualTo: snapshot.data!.docs[num]
//                                           ['uid'])
//                                   .get();
//                               nAndI.docs.forEach((element) async {
//                                 DocumentReference myStore = FirebaseFirestore
...
//                               '=========================Enter ========================');
//                           ListlastChat.add(snapshot.data!.docs[x]);
//                           var getnamesss = await _firestore
//                               .collection('users')
//                               .where('uID',
//                                   isEqualTo: snapshot.data!.docs[x]['uid'])
//                               .get();
//                           print(
//                               '=========================After Get ========================');
...
//                         } else {
//                           GroupListlastChat.add(snapshot.data!.docs[x]);
//                           var getnamesssGroup = await _firestore
//                               .collection('users')
//                               .where('uID',
//                                   isEqualTo: snapshot.data!.docs[x]['uid'])
//                               .get();
...
//                                 onLongPress: () {
//                                   DeleteView(
//                                       LastMessageId: snapshot.data!.docs[index]
//                                           ['uid'],
//                                       YourId: snapshot.data!.docs[index]['uid'],
//                                       IsGroup: snapshot.data!.docs[index]
//                                           ['isGroup'],
//                                       context: context);
//                                 },
//                                 onTap: () {
...
//                                                           height: 46,
//                                                           child: HtmlWidget(
//                                                             '<img width="46" height="46" src="${snapshot.data!.docs[index]["isGroup"] == true ? snapshot.data!.docs[index]['profilePic'] : snapshot.data!.docs[index]['profilePic']}" '
//                                                             '/>',
//                                                             factoryBuilder: () =>
//                                                                 MyWidgetFactory(),
//                                                             enableCaching: true,
...
//                                                       )
//                                                     : Text(
//                                                         "${snapshot.data!.docs[index]["isGroup"] == true ? snapshot.data!.docs[index]['name'].toString().substring(0, 1).toUpperCase() : snapshot.data!.docs[index]['name'].toString().substring(0, 1).toUpperCase()}",
//                                                         style: TextStyle(
//                                                             fontSize: 24,
//                                                             fontWeight:
//                                                                 FontWeight
...
//                                               children: [
//                                                 Text(
//                                                   "${snapshot.data!.docs[index]["isGroup"] == true ? snapshot.data!.docs[index]['name'] : snapshot.data!.docs[index]['name']}",
//                                                   textAlign: TextAlign.start,
//                                                   maxLines: 1,
//                                                   style: TextStyle(
//                                                       fontSize: 16,
...
//                           onTap: () {
//                             List Stmember =
//                                 snapshot.data!.docs[index]["member"];
//                             if (Stmember.contains(
...
//                                   isGroup: true,
//                                   VIP: snapshot.data!.docs[index]["VIP"],
//                                 ),
//                               ));
//                             } else {
//                               Navigator.of(context).push(MaterialPageRoute(
...
//     if (UserInfoList[0]["VIP"] != null) VIP = UserInfoList[0]["VIP"];
//   }
...
//       ? Drawer(
//           backgroundColor: Color(0xFF1C2931),
//           child: ListView(
//             children: [
//               UserAccountsDrawerHeader(
//                 accountName: UserInfoList.isEmpty
//                     ? Text("")
//                     : Text("${UserInfoList[0]["name"]}"),
//                 accountEmail: Row(
...
//                   ],
//                 ),
//                 currentAccountPicture: VIP
//                     ? CircleAvatar(
//                         backgroundImage: UserInfoList.isEmpty
//                             ? NetworkImage("")
//                             : NetworkImage(
...
//                         backgroundImage: AssetImage(img),
//                         child: Text(
//                           "${UserInfoList[0]["name"].toString().substring(0, 1).toUpperCase()}",
//                           style: TextStyle(
...
//               ListTile(
//                 title:
//                     Text("$AddNewStory", style: TextStyle(color: Colors.white)),
//                 onTap: () {
...
//                 },
//               ),
//               UnityBannerAd(placementId: AdManager.bannerAdPlacementId),
//             ],
//           ),
//         )
//       : Drawer(
...
//                         backgroundImage: AssetImage(img),
//                         child: Text(
//                           "${defName.toString().substring(0, 1).toUpperCase()}",
//                           style: TextStyle(
//                               fontSize: 24, fontWeight: FontWeight.bold),
//                         ),
//                       ),
...
//     });*/
//     UserInfoList = await realtimeDb()
//         .GetOneUserData(Id: "${FirebaseAuth.instance.currentUser!.uid}");
//   } else {
//     UserInfoList ==
//         await realtimeDb()
//             .GetOneUserData(Id: "${FirebaseAuth.instance.currentUser!.uid}");
...
//   var DeleteDataAndListForMeAndYou =
//       getTranslated(context, "DeleteDataAndListForMeAndYou");
...
//   var ConfirmDataAndListForMeAndYou =
//       getTranslated(context, "ConfirmDataAndListForMeAndYou");
